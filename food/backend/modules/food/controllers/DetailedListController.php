...
use backend\models\food\DetailedList;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DetailedListController implements the CRUD actions for FoodDetailedList model.
 */
class DetailedListController extends Controller
{
    ...
    /**
     * Lists all FoodDetailedList models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DetailedList();
    ...
    /**
     * Displays a single FoodDetailedList model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new FoodDetailedList model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new FoodDetailedList();

        if ($model->load(Yii::$app->request->post())) {
            $suffName = $this->uploadImageOne('FoodDetailedList', 'image');
            if ($suffName) {
    ...
    /**
     * Updates an existing FoodDetailedList model.
    ...
    /**
     * Deletes an existing FoodDetailedList model.
    ...
    /**
     * Finds the FoodDetailedList model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return FoodDetailedList the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = FoodDetailedList::findOne($id)) !== null) {
            return $model;
        } else {
