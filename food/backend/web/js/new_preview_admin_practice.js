...
//----------------------------------------------------------------------------
    ...
    onloadType:function(){
        ...
        if(showType==1 || showType==2){// 大题单选题/多选题
            ...
            if(this.childQuesJson.length==0){//没有小题
                ...
                html+='<div class="formR"><input type="checkbox" name="check" /></div>';
                html+='</div>';
                html+="</div>";
                html+='</div>';
                html+='<div class="show_subItem">';
    ...
    changeType:function(sel){
        ...
        if(type==1 ||type==2){//选择题
            ...
            html+='<div class="row">';
            html+='<div class="formL">说明:</div>';
            html+='<div class="formR"><input type="checkbox" name="child['+i+'][explanation]" id="explanation'+this.selNum+'"></div>';
            html+='</div>';
            html+='</div>';
            pa.html(html);
            uq=UE.getEditor('content'+this.selNum);
    ...
    addSub:function(){
        ...
        if(subType==9){
            ...
            html+='<div class="row">';
            html+='<div class="formL">说明:</div>';
            html+='<div class="formR"><input type="checkbox" name="child['+i+'][explanation]" id="explanation'+i+'" ></div>';
            html+='</div>';
            html+='</div>';
            }
        $('.I_'+i).append(html);
        ...
        addItem:function(child,i,j){//i小题的序列 j:小题索引
            ...
            UE.getEditor('answerContent'+i);
                ...
                html+='<div class="row">';
                html+='<div class="formL">说明:</div>';
                html+='<div class="formR"><input type="checkbox" name="child['+i+'][explanation]" id="answerContent'+i+'"></div>';
                html+='</div>';
                html+='</div>';
                html+='</div>';
                html+=' </div>';
